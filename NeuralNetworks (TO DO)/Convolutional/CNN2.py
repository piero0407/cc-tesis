...
def run_cnn():
    ...
    layer1 = convolution_layer(x_shaped, 1, 32, [5, 5], [1, 4, 4, 1], name='layer1')
    layer2 = convolution_layer(layer1, 32, 64, [3, 3], [1, 2, 2, 1], name='layer2')
    layer3 = convolution_layer(layer2, 64, 128, [3, 3], [1, 2, 2, 1], name='layer3')
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            print("Epoch:", (epoch + 1), "cost =",
                  "{:.3f}".format(avg_cost), "test accuracy: {:.3f}%".format(test_acc*100))
